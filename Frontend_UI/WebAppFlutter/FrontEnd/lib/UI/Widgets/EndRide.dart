                      ...
                      _onEndRidePressed().then((response) {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          MessageService.showMessage(context,
                              "Ride Ended Successful!", Colors.green);
                        } else {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      _onRefreshRideLocationPressed().then((response) {
                        ...
                        if (response.statusCode == 200) {
                          final Map<String, dynamic> _rideLoc = json.decode(response.body);
                          ComService.rideLatLng.add(gmaps.LatLng(_rideLoc['current_vehicle_location']['coordinates'][0],
                              _rideLoc['current_vehicle_location']['coordinates'][1]));
                          MessageService.showMessage(
                              context, "Ride location updated!", Colors.green);
                        } else {
                          MessageService.showMessage(
                              context, "Failed to show ride location!", Colors.red);
                        }
                      }, onError: (err) {
                        MessageService.showMessage(
                            context, "Failed to show ride location!", Colors.red);
