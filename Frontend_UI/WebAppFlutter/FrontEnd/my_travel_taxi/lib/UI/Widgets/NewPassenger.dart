...
import 'package:my_travel_taxi/Models/StatusEnum.dart';
                        ...
                        if (_key.currentState!.validate()) {
                          ...
                          _onCreatePressed().then((response) {
                            ...
                            if(response.statusCode == 200) {
                              ...
                              MessageService.showMessage(context, "SignUp Successful!", Colors.green);
                              Navigator.pushReplacementNamed(context, '/login');
                            }
                            else {
                              MessageService.showMessage(context, "SignUp Failed!", Colors.red);
                            }
                          },
                          onError: (_) {
                            setState(() {
