...
class _GetRideState extends State<GetRide> {
  ...
  Future<Response> _onGetRidePressed() {
    Map<String, dynamic> data = {
      "startLat": ComService.startLatLng.value.lat,
      "startLng": ComService.startLatLng.value.lng,
      "destLat": ComService.destLatLng.value.lat,
      "destLng": ComService.destLatLng.value.lng,
      "vehicle_type": "DELUXE"
    };
  ...
  setRide(body) {
    ...
    _rideDets.scheduledTime = DateTime.now();
